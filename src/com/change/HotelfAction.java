...
public class HotelfAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		}else if (action_flag.equals("order")) {
			orderhotel(request,response);
		}
	...
	private void viewhotel(HttpServletRequest request,
		...
		try {
			request.getRequestDispatcher("/hotel_single.jsp").forward(request, response);
		} catch (Exception e) {
	...
	private void orderhotel(HttpServletRequest request,
			HttpServletResponse response) {
		// TODO Auto-generated method stub
		String hoid = request.getParameter("hoid");
		request.getSession().setAttribute("hoid",hoid);
		...
		request.setAttribute("hotelMap", map);
		try {
			request.getRequestDispatcher("/hotel_order.jsp").forward(request, response);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 
