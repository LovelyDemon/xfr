...
%>
  <head>
	...
	function searchProduct(){
		...
		th.action="<%=path%>/ProductAction?action_flag=pl_search";
		th.submit();
	}
	
	function first(){
		
		window.location.href = "<%=path%>/ProductAction?action_flag=pl_search&pageNum=1";
		
	}
	function next(){
		
		window.location.href = "<%=path%>/ProductAction?action_flag=pl_search&pageNum=<%=dividePage.getCurrentPage()+1%>";		
	...
	function end(){
		...
		window.location.href = "<%=path%>/ProductAction?action_flag=pl_search&pageNum=<%=dividePage.getPageCount() %>";
			
	}
	
	function changePage(currentPage){
	
		window.location.href = "<%=path%>/ProductAction?action_flag=pl_search&pageNum="+currentPage;
	...
	function view(){
		...
		var th = document.form1;
		th.action="<%=path%>/ProductAction?action_flag=pl_view&prplid="+getSelectedValue();
		th.submit();		
