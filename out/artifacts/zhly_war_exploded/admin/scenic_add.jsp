  	         ...
  	         <div class="tab-content">
						...
						<form class="form-horizontal" action="scenic_add" method=post enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8"><input type="text" class="form-control1" id="scname" name="scname" required></div>
								</div>
								<br>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"><b>景点位置</b></label>
									<div class="col-sm-8"><input type="text" class="form-control1" id="sclocal" name="sclocal" required></div>
								</div>
								<br>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"><b>门票价格</b></label>
									<div class="col-sm-8"><input type="text" class="form-control1" id="scprice" name="scprice" required></div>
								</div>
								<br>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"><b>景点介绍</b></label>
									<div class="col-sm-8"><textarea name="scjs" id="scjs" cols="50" rows="4" class="form-control1" style="height: 176px; width: 683px; " required></textarea></div>
									
								</div>
								<br>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"><b>推荐理由</b></label>
									<div class="col-sm-8"><textarea name="sctj" id="sctj" cols="50" rows="4" class="form-control1" style="height: 138px; width: 683px; " required></textarea></div>
