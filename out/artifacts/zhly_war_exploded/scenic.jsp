		...
		<%
   			...
   			int i=0;
				...
				<div class="col-md-3 top-deal-top">
					<div class=" top-deal">
						<a href="ScenicfAction?action_flag=view&scid=<%=map.get("scid") %>" class="mask"><img src="<%=path%>/upload/<%=map.get("scpic1") %>" class="img-responsive zoom-img" alt="" style="height: 200px; width: 300px; "></a>
						<div class="deal-bottom">
							<div class="top-deal1">
								<h5><a href="ScenicfAction?action_flag=view&scid=<%=map.get("scid") %>"><%=map.get("scname") %></a></h5>
								
								<p>门票价格: <%=map.get("scprice") %> 元</p>
								<%i++; %>
							</div>
							<div class="top-deal2">
								<a href="ScenicfAction?action_flag=view&scid=<%=map.get("scid") %>" class="hvr-sweep-to-right more">详细</a>
							</div>
