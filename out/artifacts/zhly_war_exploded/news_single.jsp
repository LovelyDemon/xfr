...
<%@page import="com.change.NewsfAction"%>
...
<div class="container">
   <div class="col-md-9 blog-head">
	     ...
	     <h4><%=map.get("nename")%><br></h4>
	        <img src="<%=path%>/upload/<%=map.get("nepic") %>" class="img-responsive" alt="" style="height: 300px; width: 684px; "/><br><br>
	        
	         <h5>编辑 : <%=map.get("neactor") %> | 发布时间 : <%=map.get("nesavetime") %></h5>
	        <p><%=map.get("nenr") %></p>
	           <div class="links">
		  		  <ul class="blog-links">
		  		 </ul>
