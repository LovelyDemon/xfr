                ...
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" action="jianjie" method=post>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label"><b>介绍</b></label>

                            <div class="col-sm-8"><textarea name="jieshao" id="jieshao" cols="50" rows="4"
                                                            class="form-control1"
                                                            style="height: 182px; width: 662px; "><%out.print(jie); %>
									</textarea><br></div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label"><b>文化介绍</b></label>
                            <div class="col-sm-8"><textarea name="wenhua" id="wenhua" cols="50" rows="4"
                                                            class="form-control1"
                                                            style="height: 178px; width: 665px; "><%out.print(wen); %> </textarea>
                            </div>
