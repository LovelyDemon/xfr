<%@ page language="java" import="com.change.UmsgDao" pageEncoding="UTF-8" %>
            ...
            <form class="form-horizontal" name="form2" action="" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" class="form-control1" name="nename"
                                                 value="<%= nename!=null?nename:"" %>"/>
                        <button type="button" onclick="searchnepl()">查找</button>
                    </div>
                </div>
            </form>
            <form class="form-horizontal" form name="form1" action="" method="post">
   			...
   			if(list!=null && !list.isEmpty()){
   				...
   				for(Map<String,Object> map1 :list){%>
                                ...
                                <tr align="center">
                                    <td width=10%><input type="checkbox" name="ids" value="<%=map1.get("neplid") %>"/>
                                    </td>
                                    <td width=20%><%=map1.get("nename") %>
                                    </td>
                                    <td width=50%><%=map1.get("neplnr") %>
                                    </td>
                                    <td width=20%><%=map1.get("nepltime") %>
                                    </td>
