<%@ page language="java" import="com.change.CompanionServiceImpl" pageEncoding="UTF-8" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function del() {
            ...
            th.action = "<%=path%>/CompanionAction?action_flag=del";
            th.submit();
        ...
        <div class="xs">
            ...
            <form class="form-horizontal" name="form2" action="" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" class="form-control1" name="prname"
                                                 value="<%= productName!=null?productName:"" %>"/>
                        <button type="button" onclick="searchProduct()">查找</button>
                    </div>
                </div>
            </form>
   			...
   			if(list!=null && !list.isEmpty()){
   				...
   				for(Map<String,Object> map :list){%>
                                ...
                                <tr align="center">
                                    ...
                                    <td width=10%><%=map.get("prid") %>
                                    </td>
                                    <td width=10%><%=map.get("prname") %>
                                    </td>
                                    <td width=10%><%=map.get("prprice") %>
                                    </td>
                                    <td><%=map.get("prjs") %>
                                    </td>
