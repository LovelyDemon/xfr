...
Map<String,Object> map = (Map<String,Object>)request.getAttribute("replMap");
%>
  	       ...
  	       <h3><b>推荐评论详情</b></h3>
  	         <div class="tab-content">
						...
						<div class="form-group">
									...
									<div class="col-sm-8"><input type="text" class="form-control1" id="ids" name="ids" value=<%=map.get("replid") %> readonly></div>
								</div>
								<br>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><input type="text" class="form-control1" id="repltime" name="repltime" value=<%=map.get("repltime") %> readonly></div>
								</div>
								<br>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"><b>评论内容</b></label>
									<div class="col-sm-8"><textarea name="replnr" id="replnr" cols="50" rows="4" class="form-control1" style="height: 172px; width: 684px; "><%=map.get("replnr") %></textarea></div>
              ...
              &nbsp&nbsp<button><a href="repl_manager.jsp">返回</a></button>
                               </div>
                                 </form>
