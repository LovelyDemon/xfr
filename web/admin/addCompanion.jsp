        ...
        <div class="xs">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="horizontal-form">
                    <form class="layui-form" action="addCompanion" style="width: 750px; margin: auto">
                        <div class="layui-form-item">
                            <label class="layui-form-label">标题</label>
                            <div class="layui-input-block">
                                <input type="text" name="title" lay-verify="title" autocomplete="off"
                                       placeholder="请输入少于30字标题" class="layui-input" style="width: 500px">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="location" lay-verify="location" autocomplete="off"
                                       placeholder="请输入旅行地点，越详细越好哦！" class="layui-input" style="width: 500px">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea name="detail" placeholder="请尽可能详细的描述你的组队及出行计划哦！" class="layui-textarea"
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button class="layui-btn" lay-submit="submit" lay-filter="submit" id="submit">发布
                                </button>
                            </div>
                        </div>
                    </form>
