...
Map<String,Object> map = (Map<String,Object>)request.getAttribute("neplMap");
%>
...
<head>
	...
	function view(){
		...
		var th = document.form1;
		th.action="<%=path%>/NewsActionAction?action_flag=view&neid="+getSelectedValue();
		th.submit();		
  	       ...
  	       <h3><b>商品评论详情</b></h3>
  	         <div class="tab-content">
						...
						<div class="form-group">
									...
									<div class="col-sm-8"><input type="text" class="form-control1" id="ids" name="ids" value=<%=map.get("neplid") %> readonly></div>
								</div>
								<br>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"><b>商品名称</b></label>
									<div class="col-sm-8"><input type="text" class="form-control1" id="nename" name="nename" value=<%=map.get("nename") %> readonly></div>
								</div>
								<br>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><input type="text" class="form-control1" id="nepltime" name="nepltime" value=<%=map.get("nepltime") %> readonly></div>
								</div>
								<br>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"><b>评论内容</b></label>
									<div class="col-sm-8"><textarea name="neplnr" id="neplnr" cols="50" rows="4" class="form-control1" style="height: 172px; width: 684px; "><%=map.get("neplnr") %></textarea></div>
              ...
              &nbsp&nbsp<button><a href="nepl_manager.jsp">返回</a></button>
                               </div>
                                 </form>
