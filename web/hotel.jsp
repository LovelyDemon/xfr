<%@ page language="java" import="com.change.HotelDao" pageEncoding="UTF-8" %>
...
<div class="career">
    <div class="container">
        ...
        <form class="form-horizontal" name="form2" action="" method="post">
            <div class="blog-list">
                <h4 style="width: 1087px; ">
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp酒店名称&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp房间类型</h4>
            </div>
            <h4></h4>
            <form style="height: 67px; ">

                <div class="   right-side">
                    <br>
                    &nbsp&nbsp&nbsp<input type="text" class="form-control1" name="honame"
                                          value="<%= hotelName!=null?hotelName:"" %>"/>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<select
                        class="in-drop" style="width: 239px; height: 30px">
                    <option>大床房</option>
                    <option>标准间</option>
                    <option>其他</option>
                </select>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <button type="button" class="hvr-sweep-to-right more" onclick="searchhotel()">查找</button>
                </div>
            </form>
   				...
   				%>
                                    ...
                                    <div class="box-col">
                                        <div class=" col-sm-7 left-side ">
                                            <img class="img-responsive" src="<%=path%>/upload/<%=map.get("hopic1") %>"
                                                 alt="" style="height: 311px; width: 484px">
                                        </div>
                                        <div class="  col-sm-5 middle-side">
                                            <h4>酒店名称: <%=map.get("honame") %>
                                            </h4>
                                            ...
                                            <div class="   right-side">
                                                <a href="HotelfAction?action_flag=view&hoid=<%=map.get("hoid") %>"
